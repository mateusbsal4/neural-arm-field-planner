...
class IK_Controller:
    def __init__(self):
        ...
        # Convert and publish the start TCP position to the PMAF Planner
        ...
        # Convert and publish the goal TCP position to the PMAF Planner
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
        	...
        	# Convert and publish the current TCP position to the PMAF Planner
